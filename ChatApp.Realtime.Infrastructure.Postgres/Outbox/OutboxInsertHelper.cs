...
internal static class OutboxInsertHelper
{
        ...
        CancellationToken ct)
    {
        ...
        for (var i = 0; i < events.Count; i++)
        {
            ...
            payloadJsons[i] = JsonSerializer.Serialize(evt, RealtimeJsonSerializerContext.Default.RealtimeEvent);
        ...
        await using var command = new NpgsqlCommand(
            $"""
             ...
             ) AS arr(event_id, payload_json, target_user_id, event_type, target_user_ids_text)
